package com.samato.paymentservice.config;
...
/**
 * Byte-array KafkaTemplate for the transactional outbox publisher.
 *
 ...
 *
 * Defined as a separate factory (not a single @Primary override) so the Avro
 * template in shared-kafka keeps working for any future event publishers.
 */
@Configuration
